        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ margin: 0, fontSize: 14, color: '#64748b' }}>
              Add your products and get a full compatibility report
            </p>
          </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '24px 28px' }}>
          {!report ? (
            <div>
                ...
                {products.map((p, i) => (
                  <div key={p.id} style={{
                    ...
                    <div style={{
                      ...
                      <div style={{
                        width: 26, height: 26, borderRadius: 6, background: TEAL,
                      ...
                      <select
                        ...
                        style={{
                          ...
                          fontSize: 12, fontFamily: 'inherit', color: '#64748b',
                      ...
                      {products.length > 1 && (
                        <button onClick={() => removeProduct(p.id)} style={{
                          ...
                          color: '#cbd5e1', fontSize: 18, padding: 0, flexShrink: 0,
                        }}
                    ...
                    <div style={{ borderTop: '1px solid #f1f5f9' }}>
                      <button
                        onClick={() => setShowIngredients(prev => ({ ...prev, [p.id]: !prev[p.id] }))}
                        style={{
                      ...
                      >
                        ...
                        {showIngredients[p.id] ? 'Hide ingredient list' : 'Add ingredient list (optional — improves analysis)'}
                      </button>
                      {showIngredients[p.id] && (
                        <div style={{ padding: '0 14px 12px' }}>
                          <textarea
                            value={p.ingredients || ''}
                            onChange={e => updateProduct(p.id, 'ingredients', e.target.value)}
              ...
              {filledCount < 2 && (
                <p style={{ fontSize: 13, color: '#94a3b8', textAlign: 'center', margin: '0 0 16px' }}>
                  Add at least 2 products to run a compatibility check
                </p>
              )}
              ...
              <button
                ...
                style={{
                  ...
                  cursor: filledCount >= 2 && !loading ? 'pointer' : 'default',
            ...
            <div>
              ...
              {/* Summary */}
              <div style={{
                background: TEAL_LIGHT, border: `1px solid ${TEAL}33`,
                    ...
                    {report.conflicts.map((c, i) => (
                      <div key={i} style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                          <span style={{
                            fontSize: 11, fontWeight: 700, color: severityColor(c.severity),
              ...
              {report.conflicts?.length === 0 && (
                <div style={{
                  ...
                  <span style={{ fontSize: 14, color: '#065f46', fontWeight: 500 }}>
                    No conflicts detected — this is a compatible product combination!
                  </span>
                </div>
              )}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginBottom: 20 }}>
                {[
                  { label: '☀ Morning Routine', items: report.amRoutine },
                  { label: '☾ Evening Routine', items: report.pmRoutine },
                ].map(({ label, items }) => (
                  <div key={label} style={{
                    ...
                    <div style={{ padding: '12px 14px' }}>
                      {items?.map((item, i) => (
                        <div key={i} style={{
                          ...
                          <div style={{
                            width: 20, height: 20, borderRadius: 5, background: TEAL,
                            color: '#fff', display: 'flex', alignItems: 'center',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  {report.layeringOrder?.map((item, i) => (
                    <div key={i} style={{
                      ...
                      <div style={{
                        width: 24, height: 24, borderRadius: 6, background: TEAL,
                        color: '#fff', display: 'flex', alignItems: 'center',
                        justifyContent: 'center', fontSize: 12, fontWeight: 700, flexShrink: 0,
                      }}>{item.step}</div>
                      <div>
